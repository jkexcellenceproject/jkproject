...
class Articles extends Component {
	...
	serachArticles = event => {
		let searchArticle = _.filter(this.props.articles, article =>
	...
	renderArticles() {
		if (this.props.articles == null) {
			...
			return this.props.articles.map(article => {
				...
				const sliceText =
					article.content.rendered.length > 80
						? article.content.rendered.slice(0, 80) + '…'
		...
		return (
			<div className="blueGreen">
				<section className="ui fluid main-visual">
					<div className="bcg-base">
						...
						<div className="main-header">
							<h1 data-aos="fade-up">
								JK EXCELLENCE{' '}
								<span data-aos="data-aos" data-aos-delay="250" className="br">
									English Articles
								</span>
							</h1>
						</div>
				...
				<section className="ui container article-list content-padding">
					<h2>
						Our article<span className="line-break"> to study English</span>
					</h2>
