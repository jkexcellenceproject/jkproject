		...
		return this.props.tutors.map(tutor => {
			return (
				<div className="centered" key={tutor.slug}>
					<img className="ui small circular image centered" src={tutor.jetpack_featured_media_url} />
					<img src={tutor._embedded['wp:featuredmedia'][0].source_url} />
					<p className="description" dangerouslySetInnerHTML={{ __html: tutor.content.rendered }}></p>
					<div className="meta">
